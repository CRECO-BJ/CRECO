...
import (
	...
	"sync"
	"sync/atomic"
	"time" //	"github.com/creco/event"

	"github.com/creco/p2p/discover"
	"github.com/creco/p2p/discv5"
	"github.com/creco/p2p/nat"
	"github.com/creco/p2p/netutil"
	"github.com/goarista/monotime"
)
...
running:
	for {
		...
		case pd := <-srv.delpeer:
			// A peer disconnected.
			d := time.Duration(monotime.Now() - pd.created)
